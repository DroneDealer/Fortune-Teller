...
public class MagicManager : MonoBehaviour
{
    ...
    public void OnLoveCLicked()
    {
        ...
        {
            "Beware of love potions crafted with glitter - neither effect ever wears off!",
            "In three arcane cycles' time, you will be struck with Cupid's arrow - just make sure he hits your heart rather htna your head!",
            "You will undoubtedly find love - but whehter or not that love wil be found in this lifetime remains to be seen.",
